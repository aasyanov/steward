...
.PARAMETER BenchFilter
    ...
    Example: -BenchFilter 'Reconcile|Reload'
...
.PARAMETER NoClean
    Keep existing profiles/ contents. Default: false.

.EXAMPLE
    .\a-report-pprof.ps1
    .\a-report-pprof.ps1 -BenchFilter 'Reconcile' -TargetSamples 300
...
$modulePath = "github.com/aasyanov/steward"
...
[void]$report.AppendLine("# steward Benchmark Profiling Report")
